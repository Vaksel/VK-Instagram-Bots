...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container" style="margin-top: 100px;">
        <?php if(session('token_change_success')): ?>
            <div class="alert alert-success">
                <ul>
                    <li><?php echo e(session('token_change_success')); ?></li>
                </ul>
            </div>
        <?php endif; ?>
        <?php if(session('token_change_fail')): ?>
        ...
        <?php endif; ?>
            <div class="f-flex flex-row">
                <a href="<?php echo e(route('tokenAdd')); ?>" class="btn btn-success">Добавить токен</a>
...
<?php echo $__env->make('layouts.ipostx', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/vk.ipostx.ru/resources/views/tokens.blade.php ENDPATH**/ ?>